...
def main():
    ...
    Xa, Ya = util.load_csv('./tp1_prog_IA_Prieto_Julian/data/ds1_a.csv', add_intercept=True)
    ...
    Xb, Yb = util.load_csv('./tp1_prog_IA_Prieto_Julian/data/ds1_b.csv', add_intercept=True)
